  ...
  <div class="container">
    <div class="row g-4 py-4">
      <div class="col-12 col-md-12 col-lg-4">
        @php $categories = App\Models\Category::orderBy('id','ASC')->get(); @endphp
        @if(session()->get('language') == 'french') <h6 class="mb-4">Categories</h6> @else <h6 class="mb-4">Categories</h6> @endif
        <div class="row">
          <div class="col-12">
              ...
              @if(session()->get('language') == 'french')
                ...
                <li class="nav-item mb-2">
                  <a href="{{ route('catbasedproducts', ['cat_id'=>$category->id, 'slug'=>$name_slug_fr]) }}" 
                    class="nav-link">{{$category->category_name_fr}}</a>
                </li>
              @else 
                ...
                <li class="nav-item mb-2">
                  <a href="{{ route('catbasedproducts', ['cat_id'=>$category->id, 'slug'=>$name_slug_en]) }}" 
                    class="nav-link">{{$category->category_name_en}}</a>
                </li>
              @endif
              @endforeach
            </ul>
      ...
      <div class="col-12 col-md-12 col-lg-8">
        <div class="row g-4">
          <div class="col-6 col-sm-6 col-md-4">
            <h6 class="mb-4">@if(session()->get('language') == 'french') Get to know us @else Nous connaitre @endif</h6>
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="{{ route('about_page')}}" class="nav-link">
                @if(session()->get('language') == 'french') A propos @else About us @endif</a></li>
              <li class="nav-item mb-2"><a href="{{ route('services_page')}}" class="nav-link">
                @if(session()->get('language') == 'french') Services @else Services @endif</a></li>
              <li class="nav-item mb-2"><a href="{{ route('references')}}" class="nav-link">
                @if(session()->get('language') == 'french') References @else References @endif</a></li>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 mt-4 mt-md-0">
          <ul class="list-inline mb-0 text-lg-end text-center">
            <li class="list-inline-item mb-2 mb-md-0 text-dark">Amymgroup Mobile</li>
    ...
    <div class="border-top py-4">
      <div class="row align-items-center">
        <div class="col-md-6"><span class="small text-muted">Copyright 2022 © Amymgroup.  All rights reserved. Powered by <a href="taoficapps.com">TaoficApps</a>.</span></div>
        <div class="col-md-6">
