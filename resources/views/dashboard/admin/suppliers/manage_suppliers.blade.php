                        ...
                        <table id="key-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><td>{{$item->created_at}}</td></td>
                                    <td width="30%">
                                        <a href="{{route('admin.edit_user', $item->id)}}" class="btn btn-info" title="Edit Data"><i class="fa fa-edit"></i> </a>
                                        <a href="" class="btn btn-danger" title="Delete Data" id="delete">
                                        <i class="fa fa-trash"></i></a>
                                        @if($item->status == 1)
                                            <a href="{{ route('admin.inactivate_user', $item->id)}}" class="btn btn-danger" title="Inactive Now"><i class="fa fa-arrow-down"></i> </a>
                                        @else
                                            <a href="{{ route('admin.activate_user', $item->id)}}" class="btn btn-success" title="Active Now"><i class="fa fa-arrow-up"></i> </a>
                                        @endif
                                    </td>
                                </tr>
                                @empty
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><td>{{$item->created_at}}</td></td>
                                    <td width="20%">
                                        <a href="{{route('admin.view_supplier', $item->id)}}" class="btn btn-info" title="Edit Data"><i class="fa fa-eye"></i> </a>
                                        <a href="{{route('admin.edit_supplierForm', $item->id)}}" class="btn btn-info" title="View Data"><i class="fa fa-edit"></i> </a>
                                        <a href="" class="btn btn-danger" title="Delete Data" id="delete">
                                        <i class="fa fa-trash"></i></a>
                                        @if($item->status == 1)
                                            <a href="{{ route('admin.inactivate_user', $item->id)}}" class="btn btn-danger" title="Inactive Now"><i class="fa fa-arrow-down"></i> </a>
