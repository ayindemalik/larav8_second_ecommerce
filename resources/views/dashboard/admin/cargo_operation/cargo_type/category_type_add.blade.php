                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="{{route('admin-manage-cargo-types')}}"  class="btn btn-flat btn-sm btn-primary"
                                        >
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    ...
                                    <div class="tab-pane active" id="tab1" role="tabpanel">
                                        <form action="{{route('admin-store-cargo-type')}}"  method="POST">
                                            {{-- <form id="type-form" > --}}
                                            @csrf
                                        ...
                                        <form action="{{route('admin-store-cargo-type')}}"  method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="status" class="control-label">Countries</label>
                                                        <select class="form-select form-control-md form-control" name="country" required>
                                                            <option selected="" disabled="" value="">Choose...</option>
                                                            @foreach($countries as $country)
                                                                <option value="{{$country->id}}">{{$country->country_name_en}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="description" class="control-label">Description</label>
                                                        <textarea type="text" name="crg_typ_desc" class="form-control form-control-md rounded-0" required></textarea>
                                                    </div>
                                                </div>
