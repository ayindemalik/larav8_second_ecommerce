                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{$cargoData->sender_contact ?? ''}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                form-control-sm rounded-0" required>{{$cargoData->sender_address ?? ''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                form-control-sm rounded-0" required>{{$cargoData->receiver_address}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-xl-5">
                                            <div class="mb-3">
                                                ...
                                                <select name="shipping_type" id="shipping_type" class=" form-select form-control form-control-sm  form-control-border" required>
                                                    @if(isset($cargoData->shipping_type))
                                                    <option value="3" {{$cargoData->shipping_type == 3 ? 'selected':''}}>Country to Country</option>
                                                    <option value="2" {{$cargoData->shipping_type == 2 ? 'selected':''}}>State to State</option>
                                                    <option value="1" {{$cargoData->shipping_type == 1 ? 'selected':''}}>City to City</option>
                                                    @else
                                        ...
                                        <div class="col-xl-5">
                                            <div class="mb-3">
                                                ...
                                                <select name="package_type" id="package_type" class=" form-select form-control form-control-sm  form-control-border" required>
                                                    @if(isset($cargoData->package_type))
                                                    <option value="1" {{$cargoData->shipping_type == 1 ? 'selected':''}}>Single package</option>
                                                    <option value="2" {{$cargoData->shipping_type == 2 ? 'selected':''}} >Grouping</option>
                                                    @else
