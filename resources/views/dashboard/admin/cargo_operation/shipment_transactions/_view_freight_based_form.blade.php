                        ...
                        @foreach($cargoItems as $item)
                            <div class="d-table-row align-items-center justify-content-center my-0 py-0 freight-cargo-item">
                                <div class="d-flex align-items-center justify-content-center mb-0 pb-0">
                                    ...
                                    @endphp
                                    {{-- cbm Price Autom --}}
                                    <div class="col-1 px-1 py-1 border text-right">
                                        <span class="font-weight-bold curr_val"><b>{{ $cargoData->currency }}</b></span>
                                        <span class="font-weight-bold fprice">{{$price}}</span></div>
                                    {{-- cbm Price --}} 
                                    <div class="col-1 px-1 py-1 border text-center">{{$item->fQuantity}}</div>
                                    {{-- cbm fLength --}}
                                    <div class="col-1 px-1 py-1 border text-center">{{$item->fLength}}</div>
                                    {{-- cbm fWidth --}}
                                    <div class="col-1 px-1 py-1 border text-center">{{$item->fWidth}}</div>
                                    {{-- cbm fHeight --}}
                                    <div class="col-1 px-1 py-1 border text-center">{{$item->fHeight}}</div>
                                    {{-- discount  --}}
                                    <div class="col-1 px-2 py-1 border text-center">{{$item->discount}}</div>

                                    <div class="col-1 px-2 py-1 border text-right">
                                        <span class="font-weight-bold curr_val"><b>{{ $cargoData->currency }}</b></span>
