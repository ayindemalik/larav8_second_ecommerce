...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            @php 
                $cargoTypes = App\Models\CargoTypeList::latest()->get();
                $totCT = count($cargoTypes);
                $shippments = App\Models\CargoList::latest()->get();
                $totShip = count($shippments);
            @endphp
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-truncate font-size-14 mb-2">Total Cargo Price Tyle</p>
                                    <h4 class="mb-2">{{$totCT}}</h4>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-truncate font-size-14 mb-2">Shippments</p>
                                    <h4 class="mb-2">{{$totShip}}</h4>
