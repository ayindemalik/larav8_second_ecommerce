            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-center mb-0 pb-0">
                        ...
                        <div class="col-3 border text-center"><b id="fgtotal">0000</b>
                    ...
                    <div class="text-right">
                        <button class="btn btn-info border btn-sm btn-flat" id="add_freigh_item" type="button"><i class="fa fa-plus"></i> Add Item</button>
                    </div>
                </div>
            </div>
        </div>
...
<noscript id="freight_crg_item_clone">
    <div class="d-table-row align-items-center justify-content-center my-0 py-0 freight-cargo-item">
        ...
        <div class="d-table-cell col-1 px-2 py-1 border text-right"><span class="font-weight-bold ftotal">0.00</span></div>
    </div>
</noscript>