            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2 text-right align-right" >
                            <div class="button-items text-right align-right" >
                                <a href="{{ route('user.edit_supplierForm', $formData->id)}}" class="btn btn-info waves-effect waves-light align-right me-2"><i class="fas fa-edit"></i> Düzelt</a> 
                                <a href="{{ route('user.create_user_from_supplier', $formData->id)}}" class="btn btn-info waves-effect waves-light"><i class="fas fa-user-plus"></i> Kullanıcı oluştur</a>
                                <a href="{{ route('user.tosupplier_mail_editor', $formData->id)}}" class="btn btn-info waves-effect waves-light"><i class="fas fa-envelop"></i> Message Gönder</a>  
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label  class="form-label">ISO 9001 BELGESİ</label>
                                    <br>
                                    @if($formData->iso_document != '') 
                                    <a target="_blank" href="{{ asset($formData->iso_document) }}">View ISO Document</a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label  class="form-label">KALİTE YÖNETİM SİSTEMİNE İLİŞKİN BAŞKA BELGELERİ </label>
                                    <br>
