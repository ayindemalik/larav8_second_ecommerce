                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Add New Operation</h4>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="{{route('user-manage-income-expences')}}"  class="btn btn-flat btn-sm btn-primary" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    ...
                                    <div class="tab-pane active" id="tab1" role="tabpanel">
                                        <form action="{{route('user-store-income-expence')}}"  method="POST">
                                            @csrf
                                            <div class="row">
                                                <!-- SHIPMENT META INFO -->
                                                {{-- <div class="col-xl-8"> --}}
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="date" id="date" value="{{$date}}" class="form-control form-control-md rounded-0" 
                                                         required/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select form-control-md form-control" name="type" id="type" required>
                                                            ...
                                                            <option value="Ex">Expence</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="amount" id="amount" step="0.01"
                                                            value="" step="0.001" class="form-control form-control-md" required="">
                                                    </div>
                                                </div>
