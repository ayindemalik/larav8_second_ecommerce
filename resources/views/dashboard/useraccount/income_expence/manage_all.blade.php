                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Incomes & Expences List</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Account</a></li>
                                    <li class="breadcrumb-item active">Incomes & Expences List</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Incomes & Expences List</h3>
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="{{route('user-add-income-expence')}}" class="btn btn-flat btn-sm btn-primary">Create New</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#tab1" role="tab">
                                            ...
                                            <span class="d-none d-sm-block">Incomes</span> 
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#tab2" role="tab">
                                            <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                            <span class="d-none d-sm-block">Expences</span> 
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content p-3 text-muted">
                                                ...
                                                @forelse ($incomes as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <span class="badge badge-pill text-white bg-success"> Income </span>
                                                        </td>
                                                        <td> {{ $item->item }} </td>
                                                        <td>{{ $item->description }} </p></td>
                                                        @php $amount =  format_num($item->amount); @endphp
                                                        <td class="">
                                                            <small>{{ $item->currency }}</small> {{$item->amount}} </b><br>
                                                        </td>
                                                        <td align="center">
                                                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                                                <div class="btn-group" role="group">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                                                        <a class="dropdown-item btn"  href="{{route('user-edit-income-expence', $item->id)}}" data-id="{{ $item->id }}"
                                                                            ><span class="fa fa-edit text-primary"></span> Edit</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="dropdown-item btn"  href="{{route('user-delete-income-expence', $item->id)}}" data-id="{{ $item->id }}"
                                    ...
                                    <div class="tab-pane" id="tab2" role="tabpanel">
                                        <table id="key-datatable" class="table dt-responsive  w-100">
                                            ...
                                            <tbody>
                                                @forelse ($expences as $item)
                                                    <tr>
                                                        <td> {{ $item->date }} </td>
                                                        <td class="text-center">
                                                            <span class="badge badge-pill text-white bg-danger">Expences</span>
                                                        </td>
                                                        <td> {{ $item->item }} </td>
                                                        <td>{{ $item->description }} </p></td>
                                                        @php $amount =  format_num($item->amount); @endphp
